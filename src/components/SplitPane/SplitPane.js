...
class SplitPane extends Component {
  ...
  render() {
    ...
    if (this.props.vertical) style.flexDirection = 'column';
    ...
    let separatorStyle = this.props.separatorProps || {};
    ...
    return (
      <div
        className={this.props.css[classNames.SPLITPANE]}
        style={style}
        ref={this.spRef}
        draggable={false}
      >
        ...
        <div
          className={this.props.css[classNames.SEPARATOR]}
...
export default withTheming(SplitPane);
